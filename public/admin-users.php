...
if (!isset($_SESSION["user"]) || (int)$_SESSION["user"]["id"] !== 1) {
    ...
    $users = User::getPaginatedUsers($page, 50);

    $pagination = Paginate::createLinks($page, "", (int)User::countRows()["COUNT(*)"], 50);
    ...
    $view->content = $view->render(__DIR__ . '/../views/admin/users.php');
